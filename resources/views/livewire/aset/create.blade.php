{{-- Inventaris Modal --}}
<div wire:ignore.self class="modal fade" id="asetModal" data-backdrop="static" data-keyboard="false" tabindex="-1"
    aria-labelledby="asetModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title fw-bold" id="asetModalLabel">
                    {{ $isView ? 'Lihat' : ($isEdit ? 'Edit' : 'Tambah') }} Aset</h5>
            ...
            <div class="modal-body">
                ...
                <form wire:submit.prevent="saveAsset">
                    ...
                    <div class="form-group mb-3">
                        <label for="title">Jenis Aset <span class="text-danger">*</span></label>
