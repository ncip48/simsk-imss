{{-- Divisi Modal --}}
<div wire:ignore.self class="modal fade" id="kode-asetModal" data-backdrop="static" data-keyboard="false" tabindex="-1"
    aria-labelledby="kode-asetModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title fw-bold" id="kode-asetModalLabel">
            ...
            <div class="modal-body">
                ...
                {{-- Form starts --}}
                <form wire:submit.prevent="saveKodeAset">
